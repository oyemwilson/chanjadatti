  ...
  return (
    <section className="w-full bg-white py-16">
      <div className="max-w-[80%] mx-auto px-4 sm:px-6">
        ...
        {/* Card */}
<div
  className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0 rounded-xl overflow-hidden shadow-sm min-h-[650px] lg:min-h-[700px]"
>
          ...
          <div className="bg-[#F0F9E3] p-6 sm:p-10 ">
            ...
            <form className="space-y-5">
              ...
              <button
                type="submit"
                className="bg-[#7BA717] hover:bg-[#8aa45e] transition text-white px-6 py-3 rounded-full text-sm font-medium"
              >
                Send my message
              </button>
            </form>
